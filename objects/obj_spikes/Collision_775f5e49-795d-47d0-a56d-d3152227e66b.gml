...
scr_achievementget(84)

if obj_controller.paintedspikes>=3{
scr_achievementget(50)
}
if obj_controller.paintedspikes>=10{
scr_achievementget(51)
}
if obj_controller.paintedspikes>=18{
scr_achievementget(52)}
